...
\paragraph{Evolutionary Game Theory} Our selection result (Theorem~\ref{thm:evolution}) connects to replicator-mutation dynamics \cite{hofbauer1998evolutionary} with viability-dependent fitness.
...
\textbf{Step 2: Individual approval probabilities.} Let
\begin{equation}
