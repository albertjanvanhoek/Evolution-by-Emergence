...
The best way to use this repository is to download the zip-file in release v1.27 and feed this into your favourite chatbot/LLM. (or download all the material in the folder "pdf of content")
