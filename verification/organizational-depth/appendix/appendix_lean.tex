...
\texttt{finite\_action\_of\_kinetic\_floor}; the shorter
...
\texttt{OrganizationalDepth.lean} and
\texttt{OperationalBridge.lean}. They use Lean~4.33.0 and
...
lake build
\end{verbatim}
Both sources compile with no errors and contain no \texttt{sorry}. The axiom
audit for all manuscript-facing declarations reports only
\texttt{propext}, \texttt{Classical.choice}, and \texttt{Quot.sound}.

The manuscript-facing declarations in \texttt{OrganizationalDepth.lean}
...
declarations in \texttt{OperationalBridge.lean} cover total-variation
