...
\texttt{OperationalBridge.lean} verifies the $L^1$ contraction,
...
\begin{tabular}{@{}ll@{}}
\hline
Sources & \texttt{OrganizationalDepth.lean}; \texttt{OperationalBridge.lean} \\
Lean & 4.33.0 \\
...
\texttt{fixed\_resolution\_finite\_of\_kinetic\_floor}. The operational
bridge declarations are \texttt{dTV\_push\_le},
\texttt{dTV\_push\_idChannel},
\texttt{speed\_limit\_operational}, and
\texttt{operational\_fixed\_resolution}.
