...
/-- Every route generated by a nonnegative weighted kernel has nonnegative
total transition cost. -/
theorem Route.cost_nonneg
    {K : WeightedKernel σ} {s y : σ} {n : ℕ}
    (route : Route K s y n) :
    0 ≤ route.cost := by
  ...
  | @step s m y n hEdge rest ih =>
      ...
      exact add_nonneg (K.cost_nonneg s m hEdge) ih
...
#print axioms Route.cost_nonneg
