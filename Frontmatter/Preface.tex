...
\begin{quote}
\textbf{Current-theory note (September 2026).}
This book records the conceptual development of \emph{Evolution by Emergence}.
The current scientific theory surface is maintained in the repository files
\texttt{THEORY.md}, \texttt{DYNAMIC\_OVERVIEW.md}, and
\texttt{FORMAL\_THEORY\_MAP.md}, together with the linked Lean formalizations
and verification audits. Where the historical book and the current theory
differ in precision, scope, or evidentiary status, the current theory surface
takes precedence.
\end{quote}
