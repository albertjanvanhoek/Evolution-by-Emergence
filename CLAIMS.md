...
| CLM_EBE_CORE_021 | One seed recursive-emergence event, monotone retention, and uniformly certified critical emergence reproduction are sufficient for open-ended cumulative novelty. Countermodels show that dropping calibration, the seed, critical reproduction, or retention breaks the corresponding conclusion. | `EvolutionByEmergenceCore.lean` | Machine checked master theorem + separation witnesses | Attack any premise, reproduce the countermodels, seek a weaker sufficient condition, or identify a hidden circularity in the event-wise certification. |
